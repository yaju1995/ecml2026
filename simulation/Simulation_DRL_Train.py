...
num_ev_agents = np.array([1]) # minimum number of EV
...
simulation_config_base_dict = {
    ...
    "dt": 15 * 60,  # 15 minutes
    "num_ev_agents": 30,  # Number of EV agents    # what is the difference between above num_ev_agents and this one
    "num_nf_agents": 20, # Number of Non-flexibles agents
    "pv_area": 3000, #total pv_area (m^2)
...
simulation_config_base_dict["ev_agent_type"] = "congestion_aware" # add to handle DQN

decentralized_strategies_ca =["DQN"]
train_mode = False


num_samples = 1  # each stategy is sample 10 times and evaluate?
